...
class Test_getNextRemindTime:
    ...
    def test_remind_whole_day(self) -> None:
    ...
    def test_remind_about_upcoming_lessons(self) -> None:
    ...
    def test_should_go_over_to_next_day(self) -> None:
...
class Test_getLessonToRemind:
    ...
    def test_should_get_correct_lesson(self) -> None:
    ...
    def test_should_skip_empty_lessons(self) -> None:
    ...
    def test_should_return_none_for_last_reminded_lesson(self) -> None:
    ...
    def test_should_remind_after_the_last_reminded_lesson(self) -> None:
